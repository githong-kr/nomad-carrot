...
export default function Enter() {
  ...
  return (
    <div className="mt-16 select-none px-4">
      ...
      <div className="mt-8">
        ...
        <form className="mt-8 flex flex-col">
          ...
          <button className="mt-5 rounded-md border  border-transparent bg-orange-500 px-3 py-2 text-sm font-medium text-white shadow-sm hover:bg-orange-600 hover:transition focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2">
