      ...
      <div className="px-4">
        <div className="mb-8">
          ...
          <div className="mt-5">
            ...
            <p className="text-3l mt-3 block text-gray-900">$140</p>
            ...
            <div className="flex items-center justify-between space-x-2">
              <button className="flex-1 rounded-md bg-orange-500 py-3 font-medium text-white ring-orange-500 ring-offset-2 hover:bg-orange-600 focus:outline-none focus:ring-2">
                Talk to seller
              </button>
